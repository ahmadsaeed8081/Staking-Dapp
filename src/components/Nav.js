...
export default function Nav() {
  ...
  return (
    <div className="bg-gradient-to-br from-black to-yellow-700">
      <div>
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="relative z-10 flex items-baseline justify-between pt-2 pb-6 border-b border-gray-200">
            <a href="https://smartmoneycoin.net/" target="_blank">
              <img className="h-16 -mb-8 w-full" src="./smclogo.svg" alt="" />
            </a>
            <div className="flex items-center">
              <Menu as="div" className="relative inline-block text-left">
                {({ open }) => (
                  <>
                    <div className="bg-yellow-700 rounded-xl p-2 px-4">
                      <Menu.Button
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-8 gap-y-10">
              ...
              <div className="lg:col-span-3">
                <div className="h-full">
                  <Ads />
                  <p className="text-yellow-700 font-bold mb-4 text-xl select-none">
                    Network Overview
                  </p>
                  <NetworkOverview
                  ...
                  />
                  <p className="text-yellow-700 font-bold mt-8 mb-4 text-xl select-none">
                    My Stake
                  </p>
                  <MyStack
                    mount={mount}
