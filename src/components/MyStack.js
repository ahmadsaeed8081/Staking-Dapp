...
export default function MyStack(props) {
  ...
  return (
    <div className="grid grid-cols-1 select-none lg:grid-cols-3 lg:gap-4">
      <div className="max-w-full rounded-xl mb-4 bg-white p-3 overflow-hidden shadow-lg">
        ...
        <form>
          ...
          <div className="mt-1 flex rounded-md hover:border-white border-0 bg-gray-50 shadow-sm">
            <input
              ...
              className=" bg-gray-50 focus:ring-white flex-1 block w-full rounded-md border-0 sm:text-sm "
              placeholder="0"
              min="10000"
              max="5000000"
            />
          ...
          <div className=" mt-4 w-full">
            <div className="flex justify-between">
              <button
                type="button"
                className="bg-yellow-700 w-half text-center rounded-md mb-4 mt-2 p-2 text-sm font-medium text-white"
                onClick={() => {
                  stake(investment);
                }}
              >
            ...
            <div className="flex justify-between">
              <label className="text-xs font-medium  text-yellow-700"></label>
              <label className="text-xs font-medium  text-yellow-700">
          ...
          <div className="grid grid-cols-3 mt-6">
            <div className="max-w-xs overflow-hidden border-r-2">
              ...
              <p className="text-yellow-700 text-center font-bold text-sm lg:text-xl mb-1">
                ...
                {/* {depositAmount==} */}
                {depositAmount == 0 ? "0.5 BUSD" : depositAmount * 0.5}{" "}
                {depositAmount == 0 ? "" : "BUSD"}
              </p>
            ...
            <div className="max-w-xs overflow-hidden  border-r-2">
              ...
              <p className="text-yellow-700 text-center font-bold text-sm lg:text-xl mb-1">
                ...
                {/* {depositAmount * 15}  */}
                {depositAmount == 0 ? "15 BUSD" : depositAmount * 15}{" "}
                {depositAmount == 0 ? "" : "BUSD"}
              </p>
              <div className=" text-xs lg:text-sm font-bold tracking-wider text-center text-yellow-700">
                {/* $0.01 */}
            ...
            <div className="max-w-xs overflow-hidden">
              ...
              <p className="text-yellow-700 text-center font-bold text-sm lg:text-xl mb-1">
                ...
                {/* {depositAmount * 180} BUSD */}
                {depositAmount == 0 ? "180 BUSD" : depositAmount * 180}{" "}
                {depositAmount == 0 ? "" : "BUSD"}
              </p>
              <div className=" text-xs lg:text-sm font-bold tracking-wider text-center text-yellow-700">
                {/* $0.18 */}
