...
export default function NetworkOverview(props) {
  return (
    <div className="grid select-none grid-cols-2 md:grid-cols-3 grid-rows-2 gap-4">
      <div className="max-w-xs rounded-xl bg-yellow-700 p-3 overflow-hidden shadow-lg">
      ...
      <div className="max-w-full md:col-span-2 rounded-xl border-2 bg-white border-yellow-700 p-3 overflow-hidden shadow-lg">
      ...
      <div className="max-w-full md:col-span-2 rounded-xl bg-white p-3 overflow-hidden shadow-lg">
        <div className="text-xs lg:text-sm text-yellow-700 font-medium tracking-wider">
          My BUSD Rewards
        </div>
